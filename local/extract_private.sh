...
data_name_array=("vnceleb_train" "vnceleb_test")
data_list_path_array=("${data}/vnceleb_train/${data_type}.list" "${data}/vnceleb_test/${data_type}.list")
data_scp_path_array=("${data}/vnceleb_train/wav.scp" "${data}/vnceleb_test/wav.scp") # to count the number of wavs
nj_array=($nj $nj)
...
echo "Embedding for private_test saved to (${exp_dir}/embeddings/${data_name})"